 ...
 * На данный момент тему очень туго понимаю(с временем проблемы для нормального изучения), постораюсь в ближайщее время
 * наверстать упущенное. Если Вас не затруднит, буду презнателен если дадите сылки для изучение данной программы и
 * доп.задачи.(мой telegram https://t.me/ZangetsuRA), за ранее блоагодарю. Микрофон у Вас не очень(всех кто участвует в
 * биседе хорошо слышно, но чтобы услышать Вас, приходится выкручивать колонки на макс)
 */
